...
import { CrudRolComponent } from './components/crud-rol/crud-rol.component';
        ...
        RouterModule.forRoot([
            {
                ...
                children: [
                    ...
                    {path: 'pages/crudCategoria', component: CrudCategoriaComponent},
                    {path: 'pages/crudRol', component: CrudRolComponent},
                    {path: 'pages/crudUsuario', component: CrudUsuarioComponent},
