    ...
    ngOnInit() {
        this.model = [
            ...
            // },
            {
                label: 'Pages',
                items: [
                    {label: 'Crud Producto', icon: 'pi pi-fw pi-user-edit', routerLink: ['/pages/crud']},
                    {label: 'Crud Categoria', icon: 'pi pi-fw pi-user-edit', routerLink: ['/pages/crudCategoria']},
                    {label: 'Crud Rol', icon: 'pi pi-fw pi-user-edit', routerLink: ['/pages/crudRol']},
                    {label: 'Crud Usuario', icon: 'pi pi-fw pi-user-edit', routerLink: ['/pages/crudUsuario']},
